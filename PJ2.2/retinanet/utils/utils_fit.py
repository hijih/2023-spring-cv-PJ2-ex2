...
def fit_one_epoch(model_train, model, focal_loss, loss_history, eval, optimizer, epoch, epoch_step, epoch_step_val, gen, gen_val, Epoch, cuda, save_period, save_dir, local_rank=0):
    loss        = 0
    val_loss    = 0
    ...
    if local_rank == 0:
        ...
        eval.end_get(epoch + 1, model_train)
